...
export const getFollowersByUserId = (userID) => (dispatch) => axios.get(`/user/followed/${userID}`)
    .then((res) => dispatch({
...
export const getFollowingsByUserId = (userID) => (dispatch) => axios.get(`/user/following/${userID}`)
    .then((res) => dispatch({
...
export const addUserFollowing = (currentUserID, targetUserID) => (dispatch) => axios.post(`/follow/${currentUserID}`, targetUserID)
    .then((res) => dispatch({
...
export const removeUserFollowing = (currentUserID, targetUserID) => (dispatch) => axios.delete(`/follow/${currentUserID}`, targetUserID)
    .then((res) => dispatch({
...
export const setUserProfile = (userID, description) => (dispatch) => axios.put(`/user/${userID}`, description)
    .then((res) => dispatch({
